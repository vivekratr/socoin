    ...
    {/* register modal end */}
      ...
      <div className="relative w-full h-[90rem] text-left text-[0.88rem] text-white font-text-xs-font-medium">
        <div className=" absolute top-[0rem] left-[0rem]  w-full h-[90rem] overflow-hidden">
          <img
            className="absolute top-[1.564rem] left-[4.063rem] w-[10.5rem] h-[3.25rem] object-cover"
            alt=""
          ...
          />
          <div className="absolute top-[2.69rem] left-[24.5rem] rounded-48xl box-border w-[34.188rem] h-[3.31rem] overflow-hidden text-[1.13rem] border-[1px] border-solid border-white">
         ...
         navigate('/post')}} className="absolute top-[1rem] left-[2rem]">Create a post</div>
          ...
          <div className="absolute top-[0rem] left-[18.78rem]  box-border w-[0.06rem] h-[55.88rem] opacity-[0.48] border-r-[1px] border-solid border-gray-700" />
          ...
          <div className="absolute top-[6.838rem] left-[18.78rem]  box-border w-[46.438rem] h-[0.06rem] opacity-[0.48] border-t-[1px] border-solid border-gray-700" />
