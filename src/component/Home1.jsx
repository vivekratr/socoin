...
console.log('num',num,'type',typeof(num));
  ...
  return (
    ...
    {/* spinner */}
    <div className={` absolute   items-center justify-center h-full w-full  z-50  ${spin ? 'flex' : 'hidden'}`}>
    <div role="status" >
...
<div
      ...
      className={` absolute left-[37rem] top-[10rem] mx-auto z-10 flex flex-col items-center justify-center min-h-[50vh] ${isRegister===0 && num===0 && currentAccount!==''?'block':'hidden'}`}
    >
    ...
    <div className="max-w-2xl mt-3 mx-auto">
      <label className="block mb-2 text-sm text-left font-medium text-white dark:text-gray-300" htmlFor="file_input">Upload Profile</label>
      <input
    ...
    <div onClick={async()=>{
      ...
      setFillForm(false)}} className="relative mt-4 mx-auto rounded-[97px] bg-cornflowerblue box-border w-[9rem] h-[2.31rem] overflow-hidden text-left text-[0.88rem] text-white font-inter border-t-[1px] border-solid border-lightskyblue border-r-[1px] border-l-[1px]">
<div className="text-center relative top-2 font-medium">Next</div>
</div>
</div>

      <div className={`p-5  ${fillForm?'hidden':'block'}`}>
        <div>
        <div className="relative text-[1.38rem] font-semibold font-inter text-white text-left">Select your Interests</div>
        <div className="relative my-3 text-[0.75rem] font-inter text-white text-left">Explore the world and earn rewards</div>
        </div>
      <div className="grid grid-cols-4 gap-4 " style={{ columnGap: '20px' }}>
      {interests.map((interest) => (
        <button
          ...
          className={`rounded-[21px] min-w-fit bg-white box-border w-full overflow-hidden flex flex-row items-center justify-center py-[0.44rem] px-[2.25rem] text-left text-[0.88rem] text-black font-inter border-[1px] border-solid border-gray-400  p-2 ${
            selectedInterests.includes(interest) ? 'bg-blue-500 text-white' : ''
          }`}
        >
          {interest}
        </button>
          ...
          <div
           onClick={async()=>{
             ...
             const obj1 = {
              ...
              console.log(`Name:${regName}, Username: ${regUsername} , url : ${url} interests: ${selectedInterests}`)
...
<div className={`relative w-[12rem] h-[2.25rem] text-left text-[1rem] text-white font-inter ${userData.length>1?'':'hidden'}`}>
<b className="absolute top-[0rem] left-[2.56rem]">{userData.name}</b>
<div className="absolute top-[1.31rem] left-[2.5rem] text-[0.75rem] text-colours-gray-500">{userData.username}</div>
<div className="absolute top-[0rem] left-[0rem] rounded-[69px] bg-white w-[2.06rem] h-[2.06rem] overflow-hidden">
<img className="absolute top-[0rem] left-[0rem] rounded-[30px] w-[2.25rem] h-[2.25rem] object-cover" alt="" src={userData.profile} />
</div>
...
<img className="relative mr-5  w-[3.625rem] hover: h-[3.63rem] overflow-hidden" alt="" src="https://cdn.discordapp.com/attachments/1177493315898314792/1184104350436560906/image.png?ex=658ac21c&is=65784d1c&hm=3285308a6c83a4d8205ea999e393be2c3fd9d017d80e021cf1a96e6bd8e96d7d&" />
  <PostCard/>
<img className="relative ml-5  w-[3.625rem] hover: h-[3.63rem] overflow-hidden rotate-180" alt="" src="https://cdn.discordapp.com/attachments/1177493315898314792/1184104350436560906/image.png?ex=658ac21c&is=65784d1c&hm=3285308a6c83a4d8205ea999e393be2c3fd9d017d80e021cf1a96e6bd8e96d7d&" />
...
<img alt='e' src="https://cdn.discordapp.com/attachments/1177493315898314792/1184072438695338046/image.png?ex=658aa464&is=65782f64&hm=633b38526fb6b6da794465b600fb96b51339200700063e89bf541465c40aec95&" className="absolute top-[5.13rem] left-[1.06rem] rounded-lg bg-white w-[2.25rem] h-[2.25rem] overflow-hidden" />
<img alt='e' src="https://cdn.discordapp.com/attachments/1177493315898314792/1184072438695338046/image.png?ex=658aa464&is=65782f64&hm=633b38526fb6b6da794465b600fb96b51339200700063e89bf541465c40aec95&" className="absolute top-[9.44rem] left-[1.06rem] rounded-lg bg-white w-[2.25rem] h-[2.25rem] overflow-hidden" />
<img alt='e' src="https://cdn.discordapp.com/attachments/1177493315898314792/1184072438695338046/image.png?ex=658aa464&is=65782f64&hm=633b38526fb6b6da794465b600fb96b51339200700063e89bf541465c40aec95&" className="absolute top-[13.75rem] left-[1.06rem] rounded-lg bg-white w-[2.25rem] h-[2.25rem] overflow-hidden" />
<img alt='e' src="https://cdn.discordapp.com/attachments/1177493315898314792/1184072438695338046/image.png?ex=658aa464&is=65782f64&hm=633b38526fb6b6da794465b600fb96b51339200700063e89bf541465c40aec95&" className="absolute top-[18.06rem] left-[1.06rem] rounded-lg bg-white w-[2.25rem] h-[2.25rem] overflow-hidden" />
