...
const Home1 = () => {
  ...
  return (
    <div className="bg-black h-full">
      ...
      <div className="absolute top-[0px] left-[10px] rounded-2xl [background:linear-gradient(180.13deg,_#202020,_#181818)] box-border w-[271px] h-[229px] overflow-hidden border-t-[2px] border-solid border-[#282828] border-r-[1px] border-l-[1px]">
        <img
